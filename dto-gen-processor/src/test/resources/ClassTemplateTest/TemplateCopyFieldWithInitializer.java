...
@Generated(
        ...
        comments = "origin=com.tmtron.dtogen.processor.test.TemplateCopyFieldWithInitializer_"
)
public abstract class TemplateCopyFieldWithInitializer {

    // the template member field must be copied from the template
    protected int intField = 17;
